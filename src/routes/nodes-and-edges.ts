...
const genY = [0, 800, 1400]
const scale = [1.0, 0.8, 0.6]
const marriageX = 280;
...
export const initialNodes: Node[] = [
  // First Two Wongs
  { id: '1', position: { x: 0, y: 0 }, type: 'memberNode', data: { text: 'Wong Sing Chew', image: '/images/home-tree/Wong Sing Chew.jpg', top: false, right: false, bottom: true, left: false, scale: scale[0]}},
  { id: '2', position: { x: 400, y: 0 }, type: 'memberNode', data: { text: 'Wong Hee Yee', image: '/images/home-tree/Wong Hee Yee.jpg', top: false, right: false, bottom: true, left: false, scale: scale[0]}},
  ...
  { id: '6', position: { x: offset.AhKwo, y: genY[1] }, type: 'memberNode', data: { text: 'Ah Kwo Wong', image: '/images/home-tree/TBD.jpg', top: true, right: false, bottom: true, left: false, scale: scale[1]}},
  ...
  { id: '9', position: { x: offset.SunHop, y: genY[1] }, type: 'memberNode', data: { text: 'Sun Hop Wong', image: '/images/home-tree/TBD.jpg', top: true, right: true, bottom: true, left: false, scale: scale[1]}},
  ...
  { id: '12', position: { x: offset.AhKwo + marriageX, y: genY[1] }, type: 'memberNode', data: { text: 'Sun Lin Auyong', image: '/images/home-tree/TBD.jpg', top: false, right: false, bottom: true, left: false, scale: scale[1]}},
  ...
  { id: '16', position: { x: offset.AhKwo + 130, y: 1150 }, type: 'memberNode', data: { text: 'A.K. Wong Children', image: '/images/home-tree/AKWongs.jpg', top: true, right: false, bottom: true, left: false, scale: scale[1]}},
